...
const Portfolio = () => (
  <div>
    ...
    <div className="content padding-as-row anim-seq">
      <ProjectOverview project={"portfolio"} date={"Apr. 2019"} />
      <ProjectTools tools={[
        "React"
      ]} />
      ...
      <Text parentClasses={"section-top"} text={
        <div>
          <p>The website's concept was to create a bold, professional and minimalistic design, along with a distinct colour palette and overall look.
          </p>

...
class Experience extends Component {
  ...
  render() {
    ...
    if (this.props.exp === "Design") {
      ...
      text = <p>I have experience with <span className="text-red bold">HTML, CSS, Javascript, JQuery, React, Java, Scala, Jinja, Bootstrap, Processing and Arduino.</span> For version control and management I have experience with <span className="text-red bold">Git, Github and Trello.</span></p>;
    }
